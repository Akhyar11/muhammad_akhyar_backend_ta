...
class UserController {
    constructor() {
        this.getAllUsers = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const users = user_model_1.userModel.readWithOptionsAndFields({
        ...
        this.updateUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (body.password)
                    body.password = yield bcrypt_1.default.hash(body.password, 10);
                const oldUser = user_model_1.userModel.advancedSearch({
                    field: "id",
                    operator: "==",
                    value: id,
                    withOutFields: ["token"],
        ...
        this.getUserById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const user = user_model_1.userModel.search("id", "==", id);
                if (user.length === 0) {
