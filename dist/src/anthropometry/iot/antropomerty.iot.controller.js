    ...
    setData(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield user_model_1.userModel.search("id", "==", userId);
                ...
                const profil = yield profil_model_1.profilModel.search("userId", "==", userId);
                if (!profil[0]) {
                    yield profil_model_1.profilModel.create({
                        userId,
                        nama_lengkap: "",
                        avatarUrl: "",
                        summary,
                    ...
                    yield profil_model_1.profilModel.update(profil[0].id, { summary });
                }
                // Return response
    ...
    getAccess(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Check if user exists
                const user = yield user_model_1.userModel.search("userId", "==", userId);
                if (!user || user.length === 0) {
                ...
                // Grant access
                yield user_model_1.userModel.update(userId, Object.assign(Object.assign({}, user[0]), { iotIsAllowed: true }));
