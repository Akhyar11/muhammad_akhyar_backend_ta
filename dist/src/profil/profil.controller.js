...
class ProfilController {
    ...
    uploadProfilePicture(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const profil = yield profil_model_1.profilModel.search("id", "==", id);
                if (profil.length === 0) {
                ...
                avatar.mv(uploadPath, (err) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                ...
                const uploadPath = __dirname + "/../../tmp/uploads/" + req.files.avatar.name;
    ...
    getProfilePicture(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (profil[0].avatarUrl === "") {
                    logger_util_1.default.warn("Profile picture not found", { id });
                    const defaultAvatarPath = path_1.default.join(__dirname, "../../tmp/uploads/default-avatar.jpg");
    ...
    deleteProfilePicture(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield profil_model_1.profilModel.update(id, { avatarUrl: "" });
